                                        ...
                                        <table class="table table-responsive table-bordered table-hover" >
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_SESSION['manager'])) {
                                                    $team = $obj->my_query("select * from tbl_project where p_manager = " . $_SESSION['manager'] . " order by p_id desc");
                                                } else {
                                                ...
                                                while ($row = $team->fetch_object()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-capitalize"  style="text-align: center">
                                                            <?php echo $obj->my_select('tbl_user', ['user_id' => $row->p_create])->fetch_object()->user_name; ?>
                                                        </td>
                                                        <td class="text-capitalize"  style="text-align: center">
                                                            <?php echo $row->p_date ?>
                                                        </td>
                                                        <td class="text-capitalize"  style="text-align: center">
                                                            <a href="comment.php?project=<?php echo $obj->mc_encrypt($row->p_id); ?>">Comment(<?php echo $obj->my_count("tbl_comment", "c_id", ['c_project_id'=>$row->p_id])->fetch_object()->count; ?>)</a>
                                                        </td>
