...
if (isset($_GET['status'])) {
    if ($_GET['status'] == 1) {
        ...
        header('location:productmanager.php?display');
    } else {
...
//                        $u_info = $obj->my_select('tbl_info', ['id' => $_GET['myupdate']])->fetch_object();
                                            ...
                                            <div class="insert-from-div">
                                                ...
                                                <div class='col-md-12'>
                                                    <div class="md-form-group md-label-floating">
                                                        <input class="md-form-control" type="text" name='name' placeholder="Enter Manager Name"  required="" />
                            ...
                            <a href="productmanager.php?display">All Product Managert</a>
                            <?php
                        }
                        if (isset($_GET['display'])) {
                                    ...
                                    <div class="card-body" data-toggle="match-height"
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-responsive table-bordered table-hover" >
                                                ...
                                                <tbody>
                                                    <?php
                                                    $team = $obj->my_query("select * from tbl_user where user_role = 2 order by user_id desc");
                                                    $c = 0;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mytd">
                                                                ...
                                                                if ($row->user_status == 1) {
                                                                    ?>
                                                                    <a href="productmanager.php?status=1&id=<?php echo $row->user_id; ?>">Active</a>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <a href="productmanager.php?status=0&id=<?php echo $row->user_id; ?>">Unactive</a>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </td>
                            ...
                            <a href="productmanager.php?insert">Add Product Managert</a>
                            <?php
                        }
                        ?>
                    </div>
